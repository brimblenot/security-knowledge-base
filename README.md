...
Measured, self-paced progress through all 120 SY0-701 topics (auto-tracked from my study app) — the security foundation now certified. Cloud (AWS SAA) and networking (CCNA) study tracks are the current focus; see the [Cert Roadmap](Concepts/Cert%20Roadmap.md).
